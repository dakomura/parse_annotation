...
parser = argparse.ArgumentParser(description='hamaphoto_patch_generator')  
parser.add_argument('annot', help='annotation file')
parser.add_argument('WSIpath', help='directory for WSI(ndpi) files')
parser.add_argument('outdir', help='output directory')
parser.add_argument('-s', '--srcsize', type=int, default=512)
parser.add_argument('-p', '--patchsize', type=int, default=512)
parser.add_argument('-n', '--numpatch', type=int, default=30)
...
def main():
	...
	gen = OpenSlideGenerator(args.annot, 
				args.WSIpath, 
				args.srcsize, 
				args.patchsize,  
				dump_patch=args.outdir)
	for i in range(args.numpatch):
		gen.get_example(i)
